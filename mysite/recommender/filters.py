...
from django_filters import MultipleChoiceFilter, FilterSet, CharFilter, DateFromToRangeFilter, DateFilter

from .models import Movie

class MovieFilter(FilterSet):
    # TODO: clear each filter individually
...
class RatingFilter(FilterSet):
    ...
    date_from = DateFilter(field_name='date_rated', lookup_expr='gte', widget=forms.SelectDateWidget)
    date_to = DateFilter(field_name='date_rated', widget=forms.SelectDateWidget, method='include_end_date_day')
